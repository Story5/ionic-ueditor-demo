...
'wordOverFlowMsg':'字數超出最大允許值，伺服器可能拒絕保存！',
'ok':"確認",
'cancel':"取消",
'closeDialog':"關閉對話框",
...
'repeatType':{'options':["居中","横向重複","縱向重複","平鋪","自定義"]}
...
'searchTxt':{'value':"請輸入蒐索關鍵詞"},
'searchBtn':{'value':"百度一下"},
'searchReset':{'value':"清空蒐索"},
'noneAlign':{'title':'無浮動'},
'leftAlign':{'title':'左浮動'},
...
'errorNotSupport':'WebUploader不支持您的瀏覽器！如果你使用的是IE瀏覽器，請嚐試升級flash播放器。',
'errorLoadConfig':'後端配置項沒有正常加載，上傳插件不能正常使用！',
...
'music':{
'static':{
'lang_input_tips':"輸入歌手/歌曲/專輯，蒐索您感興趣的音樂！",
'J_searchBtn':{value:'蒐索歌曲'}
},
'emptyTxt':'未蒐索到相關音樂結果，請換一個關鍵詞試試。',
'chapter':'歌曲',
'singer':'歌手',
'special':'專輯',
'listenTest':'試聽'
...
'lang_cahrt_tip_description':'僅餅圖有效，當鼠標移動到餅圖中相應的塊上時，提示框内的文字的前綴',
...
clipboard:{style:"background:url(copy.png)-153px-1pxno-repeat;"},
